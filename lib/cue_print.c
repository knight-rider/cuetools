...
void cue_print_cdtext (struct Cdtext *cdtext, FILE *fp, int istrack)
{
	int pti;
...
void cue_print_track (FILE *fp, struct Track *track, int trackno)
{
	...
	*/
	...
	if (track_is_set_flag(track, FLAG_ANY)) {
		fprintf(fp, "FLAGS");
